...
describe("buildOutreachPack", () => {
    it("creates a private-first outreach message with strongest finding and CTA", () => {
        ...
        const outreach = buildOutreachPack(scan, "https://novaris.in/report/shared/token123");
        ...
        expect(outreach.outreachMessage).toContain("Repo Profile: https://novaris.in/repo/acme/widget");
    });
});
