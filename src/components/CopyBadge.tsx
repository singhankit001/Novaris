...
export function CopyBadge({ owner, repo }: CopyBadgeProps) {
    ...
    const markdownSnippet = `[![Analyzed by Novaris](https://img.shields.io/badge/Analyzed%20by-Novaris-4F46E5?style=for-the-badge)](${baseUrl}/repo/${owner}/${repo})`;
