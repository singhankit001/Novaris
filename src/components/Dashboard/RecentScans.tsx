...
export default function RecentScans({ userId, limit, showViewAll = false }: { userId?: string; limit?: number; showViewAll?: boolean }) {
    ...
    if (loading) {
        return (
            <div className="rounded-3xl bg-zinc-900/30 border border-white/5 overflow-hidden flex flex-col">
    ...
    return (
        <motion.div
            ...
            className="rounded-3xl bg-zinc-900/30 backdrop-blur-md border border-white/5 overflow-hidden flex flex-col hover:border-white/10 transition-colors"
        >
            <div className="p-6 border-b border-white/5 flex items-center justify-between">
