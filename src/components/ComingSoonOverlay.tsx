    ...
    return (
        <div className="absolute inset-0 z-50 flex items-center justify-center p-4">
            ...
            <motion.div
                ...
                className="relative bg-[#0a0a0c]/90 backdrop-blur-xl border border-white/10 p-8 rounded-[2.5rem] shadow-2xl max-w-sm w-full text-center overflow-hidden group"
            >
                {/* Background Glow */}
