...
const testimonials = [
    {
        ...
        content: "Novaris completely changed how I onboard into legacy codebases. What used to take 2 weeks of blindly reading code now takes me 30 minutes of chatting.",
    ...
    },
    {
        ...
        content: "I use Novaris's deep analysis to instantly scan for vulnerable code patterns across hundreds of repos. It's shockingly accurate.",
    ...
    },
    {
        ...
        content: "Tired of tracking down where that one random React context is defined? Novaris just tells you instantly and shows you exactly how it's wired across your entire application architecture.",
