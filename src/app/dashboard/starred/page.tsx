        ...
        <div className="space-y-8">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        ...
                        <p className="text-zinc-200 mt-1">Public repositories starred by @{username}</p>
                    </div>
                </div>
                <a
            ...
            {starredRepos.length === 0 ? (
                <div className="rounded-3xl bg-zinc-900 border border-white/5 p-12 flex flex-col items-center justify-center text-center space-y-4">
                    <div className="w-16 h-16 rounded-full bg-zinc-800 flex items-center justify-center text-zinc-300">
                    ...
                    {starredRepos.map((repo) => (
                        ...
                        >
                            <div>
                                ...
                                <p className="text-zinc-200 text-sm mb-4 line-clamp-2 min-h-[40px]">
